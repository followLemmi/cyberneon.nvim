...
-- Neo-tree / NvimTree
hi("NeoTreeNormal", { fg = colors.bright_magenta, bg = colors.bg_dark })
hi("NeoTreeNormalNC", { fg = colors.bright_magenta, bg = colors.bg_dark })
hi("NeoTreeDirectoryIcon", { fg = colors.cyan })
hi("NeoTreeDirectoryName", { fg = colors.cyan })
hi("NeoTreeFileName", { fg = colors.bright_magenta })
...
hi("NoiceCmdlinePopupBorder", { fg = colors.border, bg = colors.bg_dark })
